...
(function($) {
    $.slidey = function(el, options) {
        // Para evitar problemas de escopo, use 'base' em vez de 'this'
         // para fazer referência a essa classe de eventos e funções internos.
        var base = this;
        // Acesso a versões jQuery e DOM do elemento
        base.$el = $(el);
        base.el = el;
